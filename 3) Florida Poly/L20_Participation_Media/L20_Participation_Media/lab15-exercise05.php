...
<form name='mainForm' id='mainForm' method='post'>
 ...
 value="<?php echo $_POST['name']; ?>"/>
  ...
  <div class='form-group  '>
      ...
      <input name="phone" id="phone" type="text" class="form-control" placeholder="(xxx) xxx-xxxx" value="<?php echo $_POST['phone']; ?>" 
  ...
  <div class="form-group">
      ...
      <input name="how" id="how" type="text" size="30" class="form-control" placeholder="MR. Her" value="<?php echo $_POST['name']; ?>" 
